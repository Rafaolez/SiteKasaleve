...
function PGBTDetalhe() {
    ...
    return (
        <div className="det-detail-page">
            <div className="det-detail-container">

                {/* ── Topo ── */}
                <div className="det-detail-header">
                    <div>
                        <p className="det-detail-header__eyebrow">Gestão de Clientes</p>
                        <h1 className="det-detail-header__title">Detalhes do Cliente</h1>
                    </div>
                </div>

                {/* ── Card de Info ── */}
                <div className="detail-card">
                    <div className="det-detail-card__hero">
                    ...
                    <div className="det-detail-divider" />
                    ...
                    <div className="det-detail-actions">
                        <Link to="/clienti" className="link-clean"><button className="det-btn-action det-btn-action--back">← Voltar</button></Link>
                        <Link to="/editarCliente" className="link-clean"><button className="det-btn-action det-btn-action--edit">✏️ Editar</button></Link>
                        <button className="det-btn-action det-btn-action--delete">🗑 Excluir</button>
                    </div>
                </div>
