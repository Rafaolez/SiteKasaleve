...
import TipoAcaoEstoque from '../components/tipo_acao_estoque';
...
function Estoque() {
    ...
    const [entEstoque, setEntEstoque] = useState(false);

    if(entEstoque) {
        return(       
        <div className="ContainerEscolhaAcaoEstoque">
                    <h2>Escolha a ação desejada:</h2>
                    <button className="btnVoltaEscolhaEstoque"  onClick={() => setEntEstoque(false)}>
                         Entrada Estoque
                    </button>
                    {/* Letra maiúscula obrigatória para componentes */}
                    <TipoAcaoEstoque /> 
                </div>
        );
        ...
        <div className="estoque-container">
            ...
            <div className="estoque-conteudo">
                ...
                <div className="acoes-rapidas">
                    ...
                    <button className="btn-acao"  onClick={() => setEntEstoque(true)}>
                         Entrada Estoque
                    </button>
